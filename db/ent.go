...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			questiontype.Table:          questiontype.ValidColumn,
			survey.Table:                survey.ValidColumn,
			surveyinvitation.Table:      surveyinvitation.ValidColumn,
			surveyquestionanswers.Table: surveyquestionanswers.ValidColumn,
		})
	})

...
func HasChoices() predicate.Answer {
...
func HasChoicesWith(preds ...predicate.Choice) predicate.Answer {
	return predicate.Answer(func(s *sql.Selector) {
		step := newChoicesStep()
...
func HasSurveyQuestionAnswers() predicate.Answer {
	return predicate.Answer(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasSurveyQuestionAnswersWith(preds ...predicate.SurveyQuestionAnswers) predicate.Answer {
	return predicate.Answer(func(s *sql.Selector) {

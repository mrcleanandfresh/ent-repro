...
func (tx *Tx) init() {
	...
	tx.QuestionType = NewQuestionTypeClient(tx.config)
	tx.Survey = NewSurveyClient(tx.config)
	tx.SurveyInvitation = NewSurveyInvitationClient(tx.config)
	tx.SurveyQuestionAnswers = NewSurveyQuestionAnswersClient(tx.config)
}
